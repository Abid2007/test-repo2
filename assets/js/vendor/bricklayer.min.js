            ...
            l = (function () {
              ...
              return (
                ...
                (t.prototype.on = function (t, e) {
                  return (
                    this.element.addEventListener('bricklayer.' + t, e), this
                  );
                }),
                (t.prototype.redraw = function () {
                  ...
                  this.checkColumnCount(!1),
                    ...
                    n(this.element, 'bricklayer.redraw', { columnCount: t });
                }),
                (t.prototype.destroy = function () {
                  var t = this;
                  this.ruler.destroy(),
                ...
                (t.prototype.getColumns = function () {
                  return this.element.querySelectorAll(
                    ':scope > .' + this.options.columnClassName
                  );
                }),
                ...
                (t.prototype.getElementsInOrder = function () {
                  return this.element.querySelectorAll(
                    ':scope > *:not(.' +
                      this.options.columnClassName +
                      '):not(.' +
                      this.options.rulerClassName +
                      ')'
                  );
                }),
                (t.prototype.checkColumnCount = function (t) {
                  ...
                  this.columnCount !== e &&
                    (t &&
                      n(this.element, 'bricklayer.breakpoint', {
                        columnCount: e,
                      }),
                    (this.columnCount = e));
                }),
